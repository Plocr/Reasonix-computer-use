# Reasonix Computer Use 0.8.0-alpha.5

Reasonix 专用的 Windows Computer Use 插件。任务完成优先，低 token 为优化目标。

Alpha.5 已完成 QQ、QQ 音乐、Ollama Desktop 等真实应用验证，重点修复高 DPI
...
Alpha.5 当前包含 51 项自动测试，覆盖动作 schema、物理坐标、revision、首次依赖安装、
...
0.8.0-alpha.5 只正式打包 Windows 10/11 x64。macOS 和 Linux 将在 Windows 版本稳定
